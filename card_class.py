...
# Step three is for creating a Deck class
...
# Step 4 is for making a Hand class for holding the card objects
...
# writing a function to display cards
...
# Function to handle end of game scenerio
